...
AVAILABLE_BASE = {
    "UGV": {
        "Vrq1"      : [-0.12481, 0.07318,-0.0045], # left x,y,z
        "Vrq2"      : [0.01489,-0.06652,-0.0045], # top
        "Vrq3"      : [-0.12481,-0.06652,-0.0045], # right 
        # Daigonal Ouster Plate with standoffs
        # "Vrq1"      : [-0.0713284, 0.0768284, 0.0463],
        # "Vrq2"      : [0.0713284, -0.0768284, 0.0463],
        # "Vrq3"      : [-0.0713284, -0.0768284, 0.0463],
        # Diagonal Ouster Plate without standoffs
